 ...
 */
declare function getOpenAIAuth({ email, password, browser, page, timeoutMs, isGoogleLogin, captchaToken, executablePath }: {
    email?: string;
    password?: string;
    browser?: Browser;
    page?: Page;
